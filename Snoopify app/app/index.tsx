...
export default function App() {
  const [alarms, setAlarms] = useState<Alarm[]>([
    // { time: "5:30", label: "Sleep / Wake Up", enabled: true },
...
const styles = StyleSheet.create({
  ...
  modalContent: {
    ...
    padding: 20,
    width: "85%",
    height: 380, // Reduced container height
    alignItems: "center",
    justifyContent: "space-between",
  },
  deleteButton: {
  ...
  pickerContainer: {
    ...
    justifyContent: "space-between",
    width: "100%",
    marginTop: 5, // Moved closer to the title
    marginBottom: 10,
  },
  picker: {
    flex: 1,
  ...
  input: {
    ...
    padding: 10,
    width: "100%",
    marginTop: 10, // Moved closer to the pickers
    marginBottom: 5, // Reduced spacing below
    color: "#aaa",
  },
  modalButtons: {
    flexDirection: "row",
    justifyContent: "space-between",
    width: "100%",
    marginTop: 5, // Moved closer to the text box
  },
  modalButtonText: {
    color: "#ff9500",
    fontSize: 18,
